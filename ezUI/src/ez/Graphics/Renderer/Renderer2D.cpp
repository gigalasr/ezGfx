...
namespace ez {
    ...
    void Renderer2D::init(uint32_t width, uint32_t height) {
        ...
        // Load Shader
        s_Data.quad_shader =
            s_device->create_shader({{Shader::Type::VERTEX, ez::GL_QUAD_VERTEX_SHADER}, {Shader::Type::FRAGMENT, ez::GL_QUAD_FRAGMENT_SHADER}});
        ...
        // s_Data.Font = CreateRef<Font>("C:\\Windows\\Fonts\\segoeui.ttf",
        // s_device); s_Data.Font->get_texture()->bind_to_slot(2);
